...
const en = {
  ...
  form: {
    ...
    sending: "Sending…",
    sent: "Sent — we'll reply within 15 min",
    sendError: "Couldn't send — please try again or email us.",
    successTitle: "Your request has been sent",
    successBody: "Thank you! We've received your message and will get back to you within 15 minutes.",
...
const ru: Dict = {
  ...
  form: {
    ...
    sending: "Отправляем…",
    sent: "Отправлено — ответим в течение 15 минут",
    sendError: "Не удалось отправить — попробуйте ещё раз или напишите нам.",
    successTitle: "Ваше сообщение отправлено",
    successBody: "Спасибо! Мы получили вашу заявку и ответим вам в течение 15 минут.",
...
const tj: Dict = {
  ...
  form: {
    ...
    sent: "Фиристода шуд — дар давоми 15 дақиқа ҷавоб медиҳем",
    sendError: "Фиристода нашуд — лутфан боз кӯшиш кунед ё ба мо нависед.",
    successTitle: "Дархости шумо фиристода шуд",
    successBody: "Ташаккур! Паёми шуморо гирифтем ва дар давоми 15 дақиқа ҷавоб медиҳем.",
